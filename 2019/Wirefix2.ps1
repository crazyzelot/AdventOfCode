...
$pointsOnWire2 += $wire2
$value = ""
Write-Host "Entering Wire 2"
foreach ($value in $input2)
{
...
Out-File -FilePath "C:\Users\aarong\Advent of Code\Day3\PointsOnWire1.txt" -InputObject $pointsOnWire1
Out-File -FilePath "C:\Users\aarong\Advent of Code\Day3\PointsOnWire2.txt" -InputObject $pointsOnWire2
$count = 0
$pointsOnWire1.Length
$pointsOnWire2.Length
Write-Host "Entering Looping Structure"
