...
func main() {
	...
	fmt.Println("Slope of 1:1,", solution)
	...
	fmt.Println("Slope of 5:1,", solution)
	...
	fmt.Println("Slope of 7:1,", solution)

	solution = 0
	yPos = 0
	for c := 0; c < fileLength; c = c + 2 {
		if string(inputArray[c][yPos]) == "#" {
			temp := inputArray[c]
	...
	fmt.Println("Slope of 1:2,", solution)
}
